...
<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        @if ($user->image)
            <div>
                <img src="{{ $user->image }}" alt="" width="200" height="200" style="border-radius: 50%">
            </div>
        @endif
        {{-- Image --}}
        <div class="mb-4">
       ...
       {{-- Content --}}
                    <div class="mt-4">
                        ...
                        <x-textarea class="block mt-1 w-full" required id="bio"
                            name="bio" required>{{ $user->bio }}</x-textarea>
